...
export function getUrlRedirection() {
  return get(`/invitations/redirectUrl`, {}, "handle");
}
...
export function getAPIsHooks() {
  return get(`/hooks`, {}, "handle");
}

export function updateAPIsHooks(hooks) {
  return post(`/hooks`, hooks, {}, "handle");
}
